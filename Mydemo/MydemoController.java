...
public class MydemoController extends BaseController{
	...
	public String queryMydemoListView(ModelMap modelMap) {
		LinkedHashMap<String, String> flagMap = getCacheDict("AWP11002");
		modelMap.put("flagMap", transSelectOptionStrFromMap(flagMap, true));
	...
	public String modifyMydemoView(ModelMap modelMap, MydemoDTO mydemoDTO) {
		...
		modelMap.put("flagMap",
				this.transSelectOptionStrFromCacheDict("AWP11002"));
...
//		modelMap.put("flagMap", transSelectOptionStrFromMap(flagMap, true));
		...
		modelMap.put("businesskey",  mydemoDTO.getId());		
